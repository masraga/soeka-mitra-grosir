...
@section('title', 'Tambah Layanan Pengiriman')
        ...
        <div class="bg-white rounded-xl border border-gray-100 p-6 mt-2">
            <form action="{{ route('admin.shipping.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="description" value="{{ old('description') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-green-500 outline-none">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="cost" value="{{ old('cost', 0) }}" min="0" required class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-green-500 outline-none">
                ...
                <div>
                    ...
                    <input type="text" name="estimated_delivery" value="{{ old('estimated_delivery') }}" placeholder="cth: 1-2 jam" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-green-500 outline-none">
                ...
                <div class="pt-2">
                    <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2.5 rounded-lg text-sm font-medium transition">Simpan</button>
                </div>
            </form>
        </div>
    </div>
